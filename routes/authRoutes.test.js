...
describe("POST /auth/register", () => {
  ...
  //     const response = await request(app)
  //       .post("/auth/register")
  //       .send({ ...testUserData, email: "different@email.com" });
  ...
  //     const response = await request(app)
  //       .post("/auth/register")
  //       .send({ ...testUserData, username: "different" });
  //     expect(response.status).toBe(400);
  //     expect(response.body.message).toEqual("Username or email already in use");
  //   });
  // });
  ...
  //     const response = await request(app)
  //       .post("/auth/login")
  //       .send({ username: testUserData.username, password: "badpassword" });
  ...
  //     const response = await request(app)
  //       .post("/auth/login")
  //       .send({ username: "bad username", password: testUserData.password });
  //     expect(response.status).toBe(401);
  //     expect(response.body.message).toEqual("Invalid username or password");
  //   });
});
