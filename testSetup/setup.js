...
async function testBeforeAll() {
  ...
  users[0] = dateToStringConversion(
    await User.create({
      username: "testUser1",
      password: "7y6y5y4y",
      first_name: "fred",
  ...
  drinks[0] = dateToStringConversion(
    await Drink.create({
      name: "testDrink1 Ale",
  ...
  drinks[1] = dateToStringConversion(
    await Drink.create({
      name: "testDrink2 Ale",
  ...
  places[0] = dateToStringConversion(
    await Place.create({
      name: "testPlace1",
      address: "123 Test St.",
      city: "Portland",
  ...
  places[1] = dateToStringConversion(
    await Place.create({
      name: "testPlace2",
  ...
  placeRatings.push(
    dateToStringConversion(
      await PlaceRating.create(users[0].id, places[0].id, 4)
    )
  );

  placeRatings.push(
    dateToStringConversion(
      await PlaceRating.create(users[0].id, places[1].id, 5)
    )
  );

  drinkRatings.push(
    dateToStringConversion(
      await DrinkRating.create(users[0].id, drinks[0].id, 2)
    )
  );

  drinkRatings.push(
    dateToStringConversion(
      await DrinkRating.create(users[1].id, drinks[1].id, 5)
    )
  );
